using Random, Graphs, GaussianExpansionCavityMethod, SparseArrays, LinearAlgebra, Statistics, ProgressMeter, JLD2
using PyCall, Conda
...
function run_RRG(N, K, J, D, tmax, nsim)
    rng = Xoshiro(1234)
